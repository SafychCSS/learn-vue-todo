<template>
    <div class="todo-list__item list-group-item list-group-item-action d-flex align-items-center shadow-sm">
        ...
        <button @click="removeTodo" type="button" class="todo-list__item-remove close">
            <span aria-hidden="true">&times;</span>
        </button>
        <div class="form-group todo-list__edit" v-if="editing">
            <input type="text" class="form-control" v-focus @keyup.enter="editTodo" @blur="editTodo" @keyup.esc="cancelEdit" v-model="title">
            <button class="form-group__ok" @click="editTodo" :disabled="title.length === 0">
